...
-(void) initVertices
{
    ...
    GLfloat x = -width;
    GLfloat y_offset = height + 1;
    GLfloat y = y_offset - height / 2;
    ...
    quad yellowLight;
    yellowLight.color[0] = 0.0;
    yellowLight.color[1] = 0.0;
    yellowLight.color[2] = 1.0;
    yellowLight.color[3] = 1.0;
    yellowLight.x = x;
    yellowLight.y = y - y_offset * 1;
    yellowLight.z = 0;
    yellowLight.width = width;
    yellowLight.height = height;
...
- (void) update
{
    ...
    appDelegate.lblXValue.hidden = true;
    appDelegate.lblYValue.hidden = true;
    appDelegate.lblZValue.hidden = true;
...
- (void) viewDidLoad
{
    ...
    Test3AppDelegate *appDelegate = (Test3AppDelegate *) [[UIApplication sharedApplication] delegate];
    //appDelegate.lblXValue.text = @"Hi There";
...
-(void) accelerometer:(UIAccelerometer *) acelerometer didAccelerate:(UIAcceleration *)acceleration
{
    ...
    appDelegate.lblXValue.text = [[NSString alloc] initWithFormat:@"%.1f", xValue];

    appDelegate.lblYValue.text = [[NSString alloc] initWithFormat:@"%.1f", yValue];

    appDelegate.lblZValue.text = [[NSString alloc] initWithFormat:@"%.1f", zValue];
...
-(void) initialize
{
    ...
    //load textures
    [self loadTextures:[[NSBundle mainBundle  ] pathForResource:@"block" ofType:@"png"] andIndex:0];
    [self loadTextures:[[NSBundle mainBundle  ] pathForResource:@"block" ofType:@"png"] andIndex: 1];
