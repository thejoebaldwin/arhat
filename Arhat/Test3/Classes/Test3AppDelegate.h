...
@property (nonatomic, retain) IBOutlet UILabel *lblXValue;
@property (nonatomic, retain) IBOutlet UILabel *lblYValue;
@property (nonatomic, retain) IBOutlet UILabel *lblZValue;
